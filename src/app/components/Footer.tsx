...
export function Footer() {
    return (
        ...
        >
            ...
            <div className="bg-white/40 backdrop-blur-xl border-t border-white/40 pt-16 pb-28 md:pb-24">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    {/* Bottom Bar */}
                    <div className="pt-8 border-t border-black/5 flex flex-col md:flex-row items-end md:items-center justify-between gap-4 relative">
                        ...
                        {/* Spacer to keep center clear for search bar */}
